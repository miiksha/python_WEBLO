...
async def main():
    ...
    put_markdown("## Добро пожаловать в онлайн чат Михаила!\n")
    ...
    password = await input("", required=True, placeholder="Введите пароль", validate=lambda n: "неверный пароль!" if n != '2404' else None)
    ...
    while True:
        data = await input_group("💭 Новое сообщение", [
            input(placeholder="Текст сообщения ...",height=300, name="msg"),
